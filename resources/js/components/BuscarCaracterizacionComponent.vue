<template>
    <div class="buscar">
        ...
        <ul class="table table-striped" v-if="results.length > 0 && query">
...
<script>
    export default {
        ...
        watch: {
            query(after, before) {
                this.buscarCaracterizacion();
            }
        },
        methods: {
            buscarCaracterizacion() {
                axios.get('/busqueda/caracterizacion', { params: { query: this.query } })
